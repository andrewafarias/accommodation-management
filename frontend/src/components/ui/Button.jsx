...
export function Button({ 
  ...
  const variants = {
    default: 'bg-gradient-to-r from-secondary-300 to-primary-300 text-white hover:from-secondary-400 hover:to-primary-400 focus-visible:ring-primary-400 shadow-soft hover:shadow-soft-lg hover:-translate-y-0.5',
    outline: 'border-2 border-primary-200 bg-white/80 text-primary-600 hover:bg-primary-50 hover:border-primary-300 focus-visible:ring-primary-400',
