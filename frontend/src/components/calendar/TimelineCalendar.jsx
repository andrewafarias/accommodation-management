 ...
 */
export function TimelineCalendar({ units = [], reservations = [], startDate = new Date(), daysToShow = 30 }) {
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-gray-500 truncate">
                  {unit.type} • {unit.max_capacity} guests
                </div>
                ...
                {reservationsByUnit[unit.id]?.map(reservation => {
                  ...
                  return (
                    <div
                      ...
                      title={`${reservation.client.full_name} - ${format(parseISO(reservation.check_in), 'dd/MM/yyyy')} to ${format(parseISO(reservation.check_out), 'dd/MM/yyyy')}`}
                    >
